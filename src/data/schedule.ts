...
export const campDays: CampDay[] = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        section: "midday",
        details: [
          "1:00 – 1:45 — Green: Obstacle Course · Red: Pulling Tire (TTT) · Light Blue: BabyFoot · Purple: Kickball",
          "2:00 – 2:45 — Green: Pulling Tire (TTT) · Red: Obstacle Course · Light Blue: Kickball · Purple: BabyFoot",
        ],
      },
      {
        id: "d1-green-arbre",
  ...
  },
  {
    ...
    blocks: [
      ...
      // Red track
      {
        ...
        section: "midday",
        details: [
          "Green: BabyFoot · Red: Kickball · Light Blue: Obstacle Course · Purple: Pulling Tire (TTT)",
        ],
      },
      {
        id: "d2-red-rot2",
        ...
        section: "midday",
        details: [
          "Green: Kickball · Red: BabyFoot · Light Blue: Pulling Tire (TTT) · Purple: Obstacle Course",
        ],
      },
      {
        id: "d2-red-topic3-a",
