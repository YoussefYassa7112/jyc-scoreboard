  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        time: "2:30 – 4:00 PM",
        location: "Baignade — beach on the other side of the site",
        locationIds: ["baignade"],
...
/**
 * Derived from campCabins rather than written out again. These were a second
 * hardcoded copy of the roster and had already drifted — they still carried two
 * leader names the schedule sheet has since changed.
 *
...
export const greenCabins = campCabins
  .filter((c) => c.group === "green")
  .map(cabinLine);
