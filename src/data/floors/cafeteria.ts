 ...
 *
 * Parented to Jeune-Air for the same reason as the basement: CENTRAL stands
...
export const cafeteriaFloor: FloorPlan = {
  ...
  banner: "JEUNE-AIR · CENTRAL — CAFETERIA",
  ...
  rooms: [
    ...
    },
    {
      ...
      linksTo: [
        ...
        // nowhere. Outside CENTRAL's entrance is Jeune-Air.
